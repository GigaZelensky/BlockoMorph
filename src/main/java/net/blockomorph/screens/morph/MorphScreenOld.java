...
public class MorphScreenOld extends Screen {
	...
	public MorphScreenOld(Config.Mode mode, boolean init) {
        ...
        for (SavedBlock s : AbstractMorphScreen.SAVED_BLOCK_MANAGER.get().values()) {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (pageCount > 1) {
		    Component page = Component.literal(String.format("%d / %d", MorphScreenOld.page + 1, pageCount));
